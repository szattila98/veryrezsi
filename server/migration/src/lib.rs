...
mod m20220811_190343_create_currency_type_table;
mod m20220811_190827_create_recurrence_type_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20220811_190343_create_currency_type_table::Migration),
            Box::new(m20220811_190827_create_recurrence_type_table::Migration),
